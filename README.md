# real-estate-data-pipeline-databricks
Automated Serverless PySpark data pipeline in Databricks for real estate catalog normalization, currency conversion (USD/DOP), and Delta Lake storage.
